...
-- Tiempo de generación: 07-05-2024 a las 17:30:52
...
CREATE TABLE IF NOT EXISTS `expediente` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_usuario_expediente` (`id_usuario`),
  KEY `FK_mascota_expediente` (`id_mascota`),
  KEY `FK_medico_expediente` (`id_medico`),
  KEY `FK_local_expediente` (`id_local`),
  KEY `FK_medicamentos_expediente` (`id_medicamentos`),
  KEY `FK_cita_expediente` (`id_cita`),
  KEY `fk_id_vacunas` (`id_vacunas`)
...
INSERT INTO `expediente` (`id`, `id_usuario`, `id_mascota`, `id_medico`, `id_local`, `id_medicamentos`, `id_cita`, `id_vacunas`) VALUES
(1, 4, 1, 5, 1, 2, 4, 1),
(3, 1, 2, 6, 2, 2, 2, 2);
...
INSERT INTO `mascotas` (`id`, `nombre`, `peso`, `id_usuario`, `especie`) VALUES
(1, 'Brunno', '8.50', 2, 'perro'),
(2, 'Luna', '5.30', 3, 'gato');
